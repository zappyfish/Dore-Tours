...
public enum Building {
    ...
    Building(String name, double lat, double longitude, double... coords) {
        mName = name;
        mLatitude = lat;
    ...
    @Nullable
    public static Building getBuildingInView(double northMagnitude, double eastMagnitude, double lat, double lon) {
